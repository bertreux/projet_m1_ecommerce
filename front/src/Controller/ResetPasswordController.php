...
use App\Front\Form\ChangePasswordFormType;
use App\Front\Form\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, UtilisateurRepository $repository, string $token = null): Response
    {
        if ($token) {
