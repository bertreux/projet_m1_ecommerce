...
class CRUDAdresseTest extends PantherTestCase
{
    ...
    private function remplir_formulaire($crawler) {
        $crawler->filter('#adresse_intitule')->sendKeys('test');
        $crawler->filter('#adresse_ville')->sendKeys('test');
