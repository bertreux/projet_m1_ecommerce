...
class CRUDAjouterTest extends PantherTestCase
{
    private $lastRowId;
    private $firstRowId;
    private $firstRowIdAfterCreate;
    private $client;
    private $page = 'ajouter';
    ...
    private function remplir_formulaire($crawler) {
        $crawler->filter('#ajouter_qte')->sendKeys('10');
    ...
    private function edit_formulaire($crawler) {
        $crawler->filter('#ajouter_qte')->sendKeys('1');
    }
    ...
    private function edit(): void
    {
        ...
        $this->assertNotEquals('10', $qte, "La valeur avant et après la modification sont les memes");
    }
